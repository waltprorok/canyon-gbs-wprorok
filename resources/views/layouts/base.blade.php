...
<div class="flex flex-col min-h-screen">
    <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-4 dark:bg-neutral-800 dark:border-neutral-700">
        <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <a class="flex-none font-semibold text-xl text-black focus:outline-hidden focus:opacity-80 dark:text-white" href="{{ route('home') }}" aria-label="Brand">Canyon GBS App</a>
            </div>
            <div id="hs-navbar-sticky-footer" class="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow sm:block" aria-labelledby="hs-navbar-sticky-footer-collapse">
                <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                    ...
                    @auth
                        <a href="{{ route('home') }}"
                           class="font-medium text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500">Home</a>
                    @else
                        <a href="{{ route('login') }}"
    ...
    <main class="p-6 mx-auto max-w-7xl lg:p-8">@yield('body')</main>
        ...
        <div class="text-center">
            <div class="mt-3">
                <p class="text-gray-500 dark:text-neutral-500">
                    Copyright &copy; {{ now()->year }} | Canyon GBS App
                </p>
            </div>
